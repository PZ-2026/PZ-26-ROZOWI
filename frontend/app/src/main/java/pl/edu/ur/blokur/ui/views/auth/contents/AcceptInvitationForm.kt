...
fun AcceptInvitationForm(
    ...
    formFields: AcceptInvitationFormFields,
    onFormChanged: (AcceptInvitationFormFields) -> Unit,
    onSubmit: () -> Unit,
    ...
    Column(
        ...
        Text(
            text = "Wprowadź nowe hasło do swojego konta, aby aktywować swój dostęp. Hasło musi mieć co najmniej 8 znaków.",
        ...
        AnimatedVisibility(
            ...
            Column(
                ...
                Text(
                    text = (state as? AcceptInvitationState.Success)?.message ?: "",
                    style = MaterialTheme.typography.bodyMedium,
                    color = SuccessGreen,
        ...
        if (!isSuccess) {
            OutlinedTextField(
                ...
                singleLine = true,
                enabled = !isLoading,
                isError = state is AcceptInvitationState.Error,
            ...
            OutlinedTextField(
                ...
                supportingText = if (state is AcceptInvitationState.Error) {
            ...
            PrimaryButton(
                text = if (isLoading) "Zapisywanie..." else "Ustaw hasło",
                onClick = onSubmit,
                enabled = !isLoading
