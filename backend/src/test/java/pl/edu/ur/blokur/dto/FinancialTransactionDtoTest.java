...
/**
 * Testy jednostkowe klas DTO modułu transakcji finansowych. Weryfikują konstruktory, gettery,
 * settery oraz domyślny stan obiektów.
 */
...
class FinancialTransactionDtoTest {
    ...
    class RequestTests {
        ...
        void shouldCreateRequestWithAllFields() {
            ...
            assertThat(request.getTransactionDate()).isEqualTo(LocalDate.of(2026, 4, 15));
        }
        ...
        void shouldOverrideFieldsWithSetters() {
            ...
            assertThat(request.getTransactionDate()).isEqualTo(LocalDate.of(2026, 5, 1));
        }
    }
    ...
    class ResponseTests {
        ...
        void shouldCreateResponseWithAllFields() {
            ...
            assertThat(response.getTransactionDate()).isEqualTo(LocalDate.of(2026, 4, 15));
            assertThat(response.getRecordedByEmail()).isEqualTo("zarzadca@blokur.pl");
        }
    ...
    class ApartmentResponseTests {
        ...
        void shouldCreateWithBalanceAndTransactions() {
            FinancialTransactionResponse tx =
                    new FinancialTransactionResponse(
                            java.util.UUID.randomUUID(),
                            java.util.UUID.randomUUID(),
                            "WPLATA",
            ...
            ApartmentTransactionsResponse response =
                    new ApartmentTransactionsResponse(
                            new BigDecimal("700.00"), java.util.List.of(tx));

            assertThat(response.getCurrentBalance()).isEqualByComparingTo("700.00");
        ...
        void shouldCreateWithEmptyTransactionList() {
            ApartmentTransactionsResponse response =
                    new ApartmentTransactionsResponse(new BigDecimal("0.00"), java.util.List.of());
        ...
        void shouldOverrideFieldsWithSetters() {
            ApartmentTransactionsResponse response =
                    new ApartmentTransactionsResponse(
                            new BigDecimal("100.00"), java.util.List.of());

            response.setCurrentBalance(new BigDecimal("999.99"));
            response.setTransactions(null);

            assertThat(response.getCurrentBalance()).isEqualByComparingTo("999.99");
