...
/**
 * Repozytorium JPA dla encji {@link TicketComment}.
 * Zawiera złożone kwerendy łączące tabele ticket_comments i users.
 */
@Repository
public interface TicketCommentRepository extends JpaRepository<TicketComment, UUID> {

    /**
     * Pobiera komentarze do zgłoszenia wraz z danymi autora.
     * Złącza tabele ticket_comments i users w celu pobrania
     * imienia i nazwiska autora bez dodatkowych zapytań.
     *
     * @param ticketId identyfikator zgłoszenia
     * @return lista komentarzy z danymi autora posortowana od najstarszego
     */
    @Query("SELECT new pl.edu.ur.blokur.dto.TicketCommentDto("
        + "c.id, c.ticket.id, "
    ...
    /**
     * Zlicza komentarze dla danego zgłoszenia.
     * Używane przy pobieraniu listy zgłoszeń bez ładowania pełnych komentarzy.
     *
     * @param ticketId identyfikator zgłoszenia
    ...
    /**
     * Pobiera komentarze do wielu zgłoszeń wraz z danymi autora.
     * Używane do wsadowego ładowania komentarzy dla listy zgłoszeń.
     *
