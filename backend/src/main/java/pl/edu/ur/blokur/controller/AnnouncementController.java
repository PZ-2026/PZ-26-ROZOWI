...
/**
 * Kontroler obsługujący żądania HTTP dla modułu ogłoszeń. Udostępnia endpoint chroniony tokenem
 * JWT, zwracający ogłoszenia właściwe dla aktualnie zalogowanego użytkownika.
 */
@RestController
...
public class AnnouncementController {
    ...
    /**
     * Zwraca listę ogłoszeń dopasowanych do zalogowanego użytkownika. Ogłoszenia filtrowane są na
     * podstawie powiązania rezydenta z lokalem, klatką i budynkiem.
     *
