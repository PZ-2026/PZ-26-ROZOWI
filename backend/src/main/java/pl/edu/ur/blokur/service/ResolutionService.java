...
public class ResolutionService {
    ...
    /**
     * Rejestruje głos zalogowanego użytkownika na wybraną opcję w uchwale. Metoda weryfikuje
     * istnienie uchwały i opcji, a następnie próbuje zapisać rekord głosu. W przypadku próby
     * podwójnego głosowania — gdy baza danych zgłasza naruszenie unikalnego klucza {@code UNIQUE
     * (resolution_id, voter_id)} — przechwytywany jest wyjątek {@link
     * DataIntegrityViolationException} i zwracany jest błąd HTTP 409 Conflict.
     *
