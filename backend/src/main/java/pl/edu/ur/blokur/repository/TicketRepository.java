...
public interface TicketRepository extends JpaRepository<Ticket, UUID> {
    ...
    /**
     * Pobiera listę zgłoszeń jako DTO ze złączenia tabel tickets, users (autor),
     * users (konserwator) oraz ticket_categories. Lokalizacja wyznaczana jest
     * na podstawie pierwszej dostępnej wartości: lokal, klatka lub budynek.
     * Kwerenda natywna SQL — wydajny JOIN przez 4 tabele bez lazy loading.
     *
     * @return lista zgłoszeń z pełnymi danymi powiązanymi
     */
    @Query(value = "SELECT t.id, t.ticket_number, t.title, t.status, "
    ...
    /**
     * Pobiera szczegóły pojedynczego zgłoszenia jako DTO ze złączenia tabel
    ...
    /**
     * Pobiera zgłoszenia przypisane do konserwatora jako DTO
     * ze złączenia tabel tickets, users i ticket_categories.
     * Kwerenda natywna SQL filtrująca po assigned_to_id.
     *
     * @param conservatorId identyfikator konserwatora
    ...
    /**
     * Pobiera zgłoszenia widoczne dla mieszkańca (po lokalu, klatce lub budynku)
     * ze złączenia tabel tickets, users i ticket_categories.
     * Kwerenda natywna SQL z wielokrotnym LEFT JOIN.
     *
     * @param apartmentId identyfikator lokalu mieszkańca
