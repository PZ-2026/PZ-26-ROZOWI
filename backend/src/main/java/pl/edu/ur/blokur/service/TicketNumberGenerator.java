...
/**
 * Serwis generujący unikalne numery zgłoszeń w formacie {@code ZGL-RRRR-NNNN}.
 *
 ...
 *
 * <p>Przykład wygenerowanego numeru: {@code ZGL-2026-0001}.
 */
@Service
public class TicketNumberGenerator {
     ...
     * format {@code ZGL-RRRR-NNNN}, gdzie NNNN jest wypełniony zerami do 4 cyfr.
     *
     * @return numer zgłoszenia, np. {@code ZGL-2026-0001}
     */
