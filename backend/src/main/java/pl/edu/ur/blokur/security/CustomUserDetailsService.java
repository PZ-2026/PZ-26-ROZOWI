 ...
 *
 * <p>Logowanie odbywa się za pomocą adresu email jako nazwy użytkownika.
 * Weryfikacja hasła (BCrypt) jest wykonywana automatycznie przez Spring Security.</p>
 *
 * <p>Blokada konta po nieudanych próbach logowania jest obsługiwana
 * przez {@link LoginAttemptService} (in-memory), a nie przez pola w encji.</p>
 */
@Service
public class CustomUserDetailsService implements UserDetailsService {
    ...
    /**
     * Wczytuje dane użytkownika na podstawie adresu email.
     * Sprawdza czy konto jest aktywne oraz czy nie jest zablokowane.
     */
    @Override
